...
/**
 * Listing 19.8 BinaryTreeNode represents a node in a binary tree with a left
 * and * right child.
 * 
...
public class BinaryTreeNode<T>
{
    ...
    */
    public BinaryTreeNode(T obj) 
    {
       ...
       left = null;              // left child reference (pointer)
       right = null;             // right child reference (pointer)
    }
